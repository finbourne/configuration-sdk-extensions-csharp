    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { "ConfigurationUrl", "FBN_CONFIGURATION_API_URL" },
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                ConfigurationUrl = Environment.GetEnvironmentVariable("FBN_CONFIGURATION_API_URL") ?? Environment.GetEnvironmentVariable("fbn_configuration_api_url"),
