...
namespace Finbourne.Configuration.Sdk.Extensions
{
    ...
    public class ApiFactory : IApiFactory
    {
        ...
        public ApiFactory(ApiConfiguration apiConfiguration)
        {
            ...
            {
                if (string.IsNullOrWhiteSpace(apiConfiguration.ConfigurationUrl))
                    throw new ArgumentNullException(
                        nameof(apiConfiguration.ConfigurationUrl),
                        $"Configuration Uri missing. Please specify either FBN_CONFIGURATION_API_URL environment variable or configurationUrl in secrets.json.");
