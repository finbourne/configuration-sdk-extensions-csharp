...
namespace Finbourne.Configuration.Sdk.Extensions.Tests
{
    [TestFixture]
    public class ApiConfigurationBuilderTest
    {
        private const string APP = "CONFIGURATION";
        private string _secretsFile;
        private string _cachedTokenUrl;
        private string _cachedConfigurationUrl;
        ...
        public void Setup()
        {
            ...
            _cachedConfigurationUrl = Environment.GetEnvironmentVariable($"FBN_{APP}_API_URL") ??
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", _cachedConfigurationUrl);
        ...
        public void Use_Secrets_File_If_It_Exists()
        {
            PopulateDummySecretsFile(new Dictionary<string, string>
            {
                ...
                {"configurationUrl", string.Format("<{0}Url>", "configuration")},
            });            
            ...
            Assert.That(apiConfiguration.ConfigurationUrl, Is.EqualTo(string.Format("<{0}Url>", "configuration")));            
        }
        ...
        public void Use_Environment_Variables_If_No_Secrets_File_Provided()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", string.Format("<env.{0}Url>", "configuration"));
            ...
            Assert.That(apiConfiguration.ConfigurationUrl, Is.EqualTo(string.Format("<env.{0}Url>", "configuration")));            
        }
        ...
        public void Use_Configuration_Section_If_Supplied()
        {
            var settings = new Dictionary<string, string>
            {
                ...
                { "api:ConfigurationUrl", string.Format("<env.{0}Url>", "configuration") },
        ...
        public void Throw_Exception_If_Configuration_Section_Incomplete()
        {
            ...
            {
                { "api:TokenUrl", "<tokenUrl>" },
                { "api:ConfigurationUrl", string.Format("<{0}Url>", "configuration") },
                { "api:ClientId", "<clientId>" },
                { "api:ClientSecret", "" },
                { "api:Username", "<username>" },
                { "api:Password", "" },
